/* empty css                                 */
import { c as createComponent, r as renderHead, a as renderComponent, b as renderTemplate } from '../chunks/astro/server_BHsjU8LN.mjs';
import 'kleur/colors';
import 'html-escaper';
...
function ForecastMap() {
        ...
        card.innerHTML = `
          ...
          <div id="${detailsId}" style="display:none">
            ...
            <table class="details-table">
              ...
              <tbody>
                ${values.map((v) => `<tr><td>${v.time}</td><td>${v.speed.toFixed(1)}</td><td>${v.gust.toFixed(1)}</td><td>${v.dir}&deg;</td><td>${v.rain} mm</td><td>X</td><td>X</td></tr>`).join("")}
              </tbody>
            </table>
          </div>
        `;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { id: "map", className: "h-[300px] m-4 rounded-lg" }),
    /* @__PURE__ */ jsx("div", { id: "now", className: "text-center text-base" }),
    /* @__PURE__ */ jsx("div", { id: "forecast", className: "forecast grid gap-4 p-4" })
  ] });
}

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="nl"> <head><title>Kitebuddy – Kitespots</title><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css">${renderHead()}</head> <body class="bg-gray-100 font-sans"> <h1 class="text-white text-3xl text-center bg-cyan-700 p-4">Kitesurf Voorspelling – Nederland</h1> ${renderComponent($$result, "ForecastMap", ForecastMap, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/idseleveld/Downloads/kitebuddy/src/components/ForecastMap.jsx", "client:component-export": "default" })} </body></html>`;
}, "/Users/idseleveld/Downloads/kitebuddy/src/pages/index.astro", void 0);

const $$file = "/Users/idseleveld/Downloads/kitebuddy/src/pages/index.astro";
const $$url = "";
